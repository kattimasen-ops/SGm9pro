...
v13.3 - Name-Rotator + Chat-Prefill + alle v13.2-Features:
  ALLE v13.1/v13.2-Funktionen sind weiterhin enthalten (nichts entfernt).
  - NEU: Name Color Rotator (cg_handheldNameRotate/Interval/Scheme)
  - NEU: Chat-Prefill (cg_handheldChatPrefix) fuer T und Y
  - Base-Name: ->St0len-One<- (mit Null statt o in "Stolen")
...
def patch_client_cvar():
    ...
    lines = [
        "\t/* [PATCHED v13.3] Handheld Aim Assist + Name Rotator + Chat Prefill */",
...
def patch_aim_assist():
    ...
    helper_code = r"""
/* ============================================================
 * [PATCHED v13.3] Handheld Aim Assist
 *
 * Performance (v13.2):
...
"""
    ...
    with open(target_file, "w", encoding="utf-8") as f:
        f.write(content)
    print(f"[PATCHED] Aim assist v13.3 in {target_file}")
    return True


def patch_cl_main_namerotator():
    """[v13.3] Rotiert nur die Farbcodes im name-Cvar, Text bleibt gleich.

    Erwartet, dass der Name aus dem .sh z.B. so gesetzt wird:
        +set name "^4->^1S^3t^20^5l^6e^1n^7-^3O^2n^5e^4<-"
    Der Rotator strippt die Farbcodes -> Basis "->St0len-One<-"
    und baut daraus in jedem Intervall einen neuen farbigen Namen.
    """
    ...
    helper_code = r"""
/* ============================================================
 * [PATCHED v13.3] Name Color Rotator
...
"""
    ...
    anchor = "\t// see if we need to update any userinfo\n\tCL_CheckUserinfo();"
    if anchor not in content:
    ...
    with open(target_file, "w", encoding="utf-8") as f:
        f.write(content)
    print("[PATCHED] Name rotator in cl_main.c")
    return True
...
def patch_cg_view():
    ...
    zoom_helper = r"""
/* ============================================================
 * [PATCHED v13.3] Dynamic Zoom + Auto-Switch
 * ============================================================ */
...
def patch_cg_hitmarker():
    ...
    hitmarker_code = r"""
/* ============================================================
 * [PATCHED v13.3] Hitmarker + Damage-Indicator
 * ============================================================ */
...
def main():
    ...
    applied = 0
    if is_smokinguns:
        print("==> Patching SmokinGuns (v13.3)")
        diagnostic_dump()
