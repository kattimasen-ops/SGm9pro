...
v14.4 - vm.c Pfad-Fix + Chat-Prefill v2 (alle Message-Modes).
"""
...
def patch_cg_hitmarker():
    """
    v14.3: Hitmarker X-Form + praeziser Richtungs-Damage-Indicator (Ring-Dots).
    """
    target_file = None
    for root, _dirs, files in os.walk("code"):
...
def main():
    ...
    applied = 0
    if is_smokinguns:
        print("==> Patching SmokinGuns (v14.4)")
        diagnostic_dump()
